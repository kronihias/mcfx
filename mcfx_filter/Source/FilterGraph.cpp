...
void FilterGraph::changed(bool changed)
{
    changed_ = changed;
}
...
void FilterGraph::setDragButton(int idx, float f, float g)
{
    btn_drag.getUnchecked(idx)->setBounds (hztoxpos(f)-5, dbtoypos(g)-5, 10, 10);
}
...
const char* FilterGraph::drag_off_png = (const char*) resource_FilterGraph_drag_off_png;
const int FilterGraph::drag_off_pngSize = 903;
...
const char* FilterGraph::drag_on_png = (const char*) resource_FilterGraph_drag_on_png;
const int FilterGraph::drag_on_pngSize = 1172;
...
const char* FilterGraph::drag_over_png = (const char*) resource_FilterGraph_drag_over_png;
const int FilterGraph::drag_over_pngSize = 693;

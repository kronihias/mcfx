    ...
    private:
        ...
        static juce::String helpBody()
        {
            ...
            return juce::String::fromUTF8 (
                ...
                "  Cmd / Ctrl + A          Select all nodes on this level\n"
                ...
                "  Option / Alt + drag     Drop a node on a wire to insert it\n"
                "                          there (all wires between those two\n"
                "                          nodes, up to its channel count; the\n"
                "                          node must not be wired yet)\n"
